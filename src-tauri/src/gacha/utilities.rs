...
use super::{GachaRecord, GachaUrl, KuroGachaRecordFetcher, MihoyoGachaRecordFetcher};
use crate::constants;
...
pub(crate) async fn find_mihoyo_gacha_url_and_validate_consistency<Record, Fetcher>(
    fetcher: &Fetcher,
    facet: &AccountFacet,
    uid: &str,
    gacha_urls: &[GachaUrl],
...
where
    ...
    Fetcher: MihoyoGachaRecordFetcher<Target = Record>,
{
    debug!(
